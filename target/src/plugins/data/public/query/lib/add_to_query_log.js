...
exports.createAddToQueryLog = void 0;
const get_query_log_1 = require("./get_query_log");
function createAddToQueryLog({ storage, uiSettings }) {
    /**
     ...
     */
    return function addToQueryLog(appName, { language, query }) {
        const persistedLog = get_query_log_1.getQueryLog(uiSettings, storage, appName, language);
