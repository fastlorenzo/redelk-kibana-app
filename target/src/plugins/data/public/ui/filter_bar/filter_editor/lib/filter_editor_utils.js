...
exports.isFilterValid = exports.validateParams = exports.getOperatorOptions = exports.getFilterableFields = exports.getOperatorFromFilter = exports.getFieldFromFilter = void 0;
...
function validateParams(params, type) {
    switch (type) {
        ...
        case 'ip':
            try {
                return Boolean(new common_1.Ipv4Address(params));
            }
            catch (e) {
                return false;
            }
...
function isFilterValid(indexPattern, field, operator, params) {
    ...
    switch (operator.type) {
        ...
        case 'range':
            ...
            return ((!params.from || validateParams(params.from, field.type)) &&
