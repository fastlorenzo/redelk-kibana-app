...
exports.VisTypeIcon = ({ icon, image }) => {
    return (react_1.default.createElement(react_1.default.Fragment, null,
        image && react_1.default.createElement("img", { src: image, alt: "", className: "visNewVisDialog__typeImage" }),
        !image && react_1.default.createElement(eui_1.EuiIcon, { type: icon || 'empty', size: "l", color: "secondary" })));
};
