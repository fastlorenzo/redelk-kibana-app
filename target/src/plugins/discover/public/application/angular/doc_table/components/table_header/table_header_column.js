...
exports.TableHeaderColumn = void 0;
...
function TableHeaderColumn({ colLeftIdx, colRightIdx, displayName, isRemoveable, isSortable, name, onChangeSortOrder, onMoveColumn, onRemoveColumn, sortOrder, }) {
    ...
    const getSortButtonAriaLabel = () => {
        const sortAscendingMessage = i18n_1.i18n.translate('discover.docTable.tableHeader.sortByColumnAscendingAriaLabel', {
            defaultMessage: 'Sort {columnName} ascending',
            values: { columnName: name },
        });
        const sortDescendingMessage = i18n_1.i18n.translate('discover.docTable.tableHeader.sortByColumnDescendingAriaLabel', {
            defaultMessage: 'Sort {columnName} descending',
            values: { columnName: name },
        });
        const stopSortingMessage = i18n_1.i18n.translate('discover.docTable.tableHeader.sortByColumnUnsortedAriaLabel', {
    ...
    const buttons = [
        ...
        // Remove Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('discover.docTable.tableHeader.removeColumnButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('discover.docTable.tableHeader.removeColumnButtonTooltip', {
        ...
        // Move Left Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('discover.docTable.tableHeader.moveColumnLeftButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('discover.docTable.tableHeader.moveColumnLeftButtonTooltip', {
        ...
        // Move Right Button
        {
            ...
            ariaLabel: i18n_1.i18n.translate('discover.docTable.tableHeader.moveColumnRightButtonAriaLabel', {
            ...
            tooltip: i18n_1.i18n.translate('discover.docTable.tableHeader.moveColumnRightButtonTooltip', {
