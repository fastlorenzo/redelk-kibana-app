...
exports.isNewPlatformPlugin = exports.parseManifest = void 0;
...
async function parseManifest(pluginPath, packageInfo, log) {
    ...
    if (manifest.extraPublicDirs &&
        ...
        throw plugin_discovery_error_1.PluginDiscoveryError.invalidManifest(manifestPath, new Error(`The "extraPublicDirs" in plugin manifest for "${manifest.id}" should be an array of strings.`));
    }
