...
const levelSchema = config_schema_1.schema.oneOf([
 ...
 * @public
 */
exports.loggerSchema = config_schema_1.schema.object({
...
exports.config = {
    ...
    schema: config_schema_1.schema.object({
        ...
        loggers: config_schema_1.schema.arrayOf(exports.loggerSchema, {
            defaultValue: [],
        }),
 ...
 * @public
 */
exports.loggerContextConfigSchema = config_schema_1.schema.object({
    appenders: config_schema_1.schema.mapOf(config_schema_1.schema.string(), appenders_1.Appenders.configSchema, {
        defaultValue: new Map(),
    }),
    loggers: config_schema_1.schema.arrayOf(exports.loggerSchema, { defaultValue: [] }),
});
/**
...
class LoggingConfig {
    ...
    extend(contextConfig) {
        ...
        const mergedLoggers = new Map([
            ...this.configType.loggers.map((l) => [l.context, l]),
            ...contextConfig.loggers.map((l) => [l.context, l]),
        ]);
        const mergedConfig = {
